  ...
  try {
    ...
    const eventsData = [
      ...
      },
      {
        ...
        categoryId: "event_status_change",
      },
      {
        projectId: completedDevelopment.id,
