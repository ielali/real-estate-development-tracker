      ...
      <div className="px-6 py-6 max-w-7xl">
        ...
        <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex gap-2">
            {/* Show "View Vendor Performance" button if contact has associated costs */}
            {data.costs.length > 0 && (
              <Button variant="secondary" onClick={() => router.push(`/vendors/${contactId}`)}>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="space-y-6 lg:col-span-2">
            {/* Vendor Performance Metrics (only shown if contact has been used as vendor) */}
            <VendorMetricsCard contactId={contactId} />

            {/* Vendor Ratings Section (only shown if contact has been used as vendor) */}
            <VendorRatingsSection contactId={contactId} currentUserId={session?.user?.id} />
