...
- [ ] Create DocumentLinkSelector component (AC: 5)
  - [ ] Create `components/documents/DocumentLinkSelector.tsx`
  - [ ] Show searchable/filterable document list
  - [ ] Support multi-select with checkboxes
  - [ ] Display document thumbnails and metadata
  - [ ] Filter by category and search by filename
  - [ ] Show currently linked documents (checked by default)
  - [ ] Integrate with linkToEntity mutation
  - [ ] Handle optimistic updates
  - [ ] Mobile-optimized layout

- [ ] Create RelatedDocuments display component (AC: 4)
  - [ ] Create `components/documents/RelatedDocuments.tsx`
  - [ ] Display grid of linked documents
  - [ ] Show thumbnails, filenames, categories
  - [ ] Add download and unlink actions
  - [ ] Empty state when no documents linked
  - [ ] Loading skeleton while fetching
  - [ ] Responsive grid layout

- [ ] Integrate DocumentLinkSelector into entity pages (AC: 1, 2, 3)
  - [ ] Add "Link Documents" button to Cost detail view
  - [ ] Add "Link Documents" button to Event detail view
  - [ ] Add "Link Documents" button to Contact detail view
  - [ ] Show RelatedDocuments component on each entity page
  - [ ] Refresh related documents after link/unlink
...
- Frontend components (DocumentLinkSelector, RelatedDocuments, OrphanedDocuments)
- Integration into entity pages
