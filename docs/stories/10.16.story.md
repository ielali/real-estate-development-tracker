...
- [ ] Task 1: Set up Epic 10.3 design tokens (AC: 14,15)
  - [ ] Add Inter font import to layout
  - [ ] Add Material Symbols Outlined import
  - [ ] Configure Tailwind with navy/primary colors
  - [ ] Verify dark mode class toggle works
  - [ ] Test color contrast ratios (WCAG AA)

### Phase 2: Login Page Structure

- [ ] Task 2: Create split-panel layout (AC: 1,2,3)
  - [ ] Create left panel with hero image and overlay
  - [ ] Add branding (logo + "Real Estate Tracker" text)
  - [ ] Create right panel with centered form container
  - [ ] Add mobile logo (visible on small screens only)
  - [ ] Test responsive breakpoints (lg: 1024px)

- [ ] Task 3: Build login form UI (AC: 4,5,6,7)
  - [ ] Add "Welcome Back" heading
  - [ ] Create email input with label
  - [ ] Create password input with visibility toggle
  - [ ] Add remember me checkbox
  - [ ] Add "Forgot password?" link
  - [ ] Create sign-in button with hover states
  - [ ] Apply Inter font and proper typography weights
...
- [ ] Task 4: Implement email validation (AC: 4)
  ...
  - [ ] Update border color on validation error (red)
  - [ ] Clear error when user corrects input
  - [ ] Use Zod schema for validation rules

- [ ] Task 5: Implement password validation (AC: 5)
  - [ ] Add password visibility toggle functionality
  - [ ] Switch icon between visibility/visibility_off
  - [ ] Ensure password field clears on logout
  - [ ] Add keyboard support (Enter to submit)

### Phase 4: Social Login UI

- [ ] Task 6: Add social login buttons (AC: 8,12,13)
  - [ ] Create divider with "Or continue with" text
  - [ ] Add Google login button with logo SVG
  - [ ] Add Facebook login button with logo SVG
  - [ ] Grid layout (2 columns) for buttons
  - [ ] Hover states and transitions
  - [ ] Mark as placeholders (future implementation)

### Phase 5: 2FA Screen

- [ ] Task 7: Build 2FA UI (AC: 9,10,11,12)
  - [ ] Create 2FA card (initially hidden)
  - [ ] Add back button with arrow icon
  - [ ] Add lock icon in colored circle
  - [ ] Add "Two-Factor Authentication" heading
  - [ ] Add instruction text
  - [ ] Create 6-digit code input fields
  - [ ] Style input fields (large, centered text)
  - [ ] Add "Verify Code" button

- [ ] Task 8: Implement 2FA interactions (AC: 10,11,13)
  ...
  - [ ] Smooth transition between login and 2FA

### Phase 6: Dark Mode

- [ ] Task 9: Implement dark mode support (AC: 14)
  - [ ] Add dark: variants for all backgrounds
  - [ ] Update text colors for dark mode
  - [ ] Update border colors for dark mode
  - [ ] Update input field styles for dark mode
  - [ ] Update button colors for dark mode
  - [ ] Test contrast ratios in dark mode
  - [ ] Verify hero image overlay in dark mode

### Phase 7: Mobile Responsiveness

- [ ] Task 10: Optimize for mobile (AC: 16)
  - [ ] Hide hero image panel on mobile (< lg)
...
- [ ] Task 11: Implement accessibility features (AC: 17)
  - [ ] Add proper label associations (htmlFor)
  - [ ] Add aria-labels where needed
  - [ ] Add aria-describedby for error messages
  - [ ] Ensure keyboard navigation works (Tab, Enter)
  - [ ] Add focus indicators (ring-2 ring-primary/50)
...
- [ ] Task 12: Integrate authentication logic (AC: 18,19)
  - [ ] Connect login form to better-auth signIn
  - [ ] Handle authentication errors
  - [ ] Show loading state during sign-in
  - [ ] Disable submit button while loading
  - [ ] Connect 2FA verification to better-auth
  - [ ] Handle 2FA errors (invalid code)
  - [ ] Implement remember me functionality
  - [ ] Implement trust device functionality
  - [ ] Add error toast notifications

- [ ] Task 13: Add loading states (AC: 18)
  - [ ] Add spinner icon to sign-in button
  - [ ] Disable form inputs during submission
  - [ ] Show loading state on verify button
  - [ ] Add skeleton loader if needed
